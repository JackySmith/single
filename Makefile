...
GO_LINKER_FLAGS ?= -ldflags \
				   "-X github.com/JackySmith/single/model.BuildNumber=$(BUILD_NUMBER)\
				    -X 'github.com/JackySmith/single/model.BuildDate=$(BUILD_DATE)'\
				    -X github.com/JackySmith/single/model.BuildHash=$(BUILD_HASH)"
